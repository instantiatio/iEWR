...
Статус: **опубликованный Beta-выпуск**. [iEWR 5.5.3 Beta](https://github.com/instantiatio/iEWR/releases/tag/5.5.3-beta) — текущий Latest; архив и пределы проверки указаны на странице выпуска.
Это основной README поставки: назначение, начало работы, использование и границы.

- [Изменения 5.5.3](RELEASE_NOTES.md) — что изменилось, условия перехода и ограничения. [История 5.2.2–5.5.2](RELEASE_HISTORY.md) сохранена отдельно.
