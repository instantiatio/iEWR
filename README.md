...
Версия: **5.2.2-beta.3**. Редакция документации 2 принята и опубликована
в [GitHub Releases](https://github.com/instantiatio/iEWR/releases/tag/v5.2.2-beta.3).
Выпуск включает доработки выбора DPF, хранения файлов и ведения поручения.
Принятый архив опубликован без пересборки; в основной ветке отдельно обновлены
сведения о приёмке и публикации. Код и правила работы сохранены.
Состав изменений, результаты испытаний и границы применения — в
[сведениях о поставке](BASELINE_STATUS.md). Версия остаётся бета;
общая эксплуатационная готовность не заявляется (`distribution_ready=false`).
