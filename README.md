...
Статус: **опубликованный Beta-выпуск**. [iEWR 5.5.0 Beta](https://github.com/instantiatio/iEWR/releases/tag/5.5.0-beta) — текущий Latest; архив и пределы проверки указаны на странице выпуска.
Это основной README поставки: назначение, начало работы, использование и границы.

- [Release notes: 5.2.2 → 5.5.0](RELEASE_NOTES.md) — накопленные изменения, совместимость, миграция и известные ограничения выпуска.
...
DEEP меняет начальное раскрытие деталей, сохраняя существенные условия и выводы.
