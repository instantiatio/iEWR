...
Статус: **Beta**. [Выпуск iEWR 5.3.1 Beta](https://github.com/instantiatio/iEWR/releases/tag/v5.3.1-beta) опубликован 16 сентября 2026.
Это основной README поставки: назначение, начало работы, использование и границы.

- [Release notes: 5.2.2 → 5.3.1](RELEASE_NOTES.md) — накопленные изменения, совместимость, миграция и известные ограничения выпуска.
