...
Версия: **5.2.2 Beta**. Изменения относительно 5.2.1 охватывают применение DPF,
хранение файлов и ведение поручения. Единый указатель открывает доступ ко всем
123 методам шести встроенных DPF. Состав, проверки и границы применения — в
[сведениях о поставке](BASELINE_STATUS.md).
