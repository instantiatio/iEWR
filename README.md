...
Статус: **опубликованный Beta-выпуск**. [iEWR 5.5.1 Beta](https://github.com/instantiatio/iEWR/releases/tag/5.5.1-beta) — текущий Latest; архив и пределы проверки указаны на странице выпуска.
Это основной README поставки: назначение, начало работы, использование и границы.

- [Release notes: 5.2.2 → 5.5.1](RELEASE_NOTES.md) — накопленные изменения, совместимость, миграция и известные ограничения выпуска.
...
действие после ответа. Форма выбирается по ситуации. Уже разрешённое продолжается;
...
**Полный [Engineering DPF Suite](https://github.com/ailev/FPF/tree/main/Engineering%20DPF%20Suite) также не входит в поставку.** Включены семь избранных авторских предметных рамок:
...
Семь авторских DPF закреплены на commit `b8d6d845ba50ef52c233b8188f0e94b6368a80f7`. Авторская дата PSD — 5 September 2026, остальных шести — 11 September 2026. Локальная revision хранит commit отдельно от авторской даты; raw bytes не изменены. Локальный SDLC 0.1.0 сохранён.
